...
import { Octicons,MaterialCommunityIcons,Fontisto,FontAwesome} from '@expo/vector-icons';
    ...
    render(){
        return(
            <Container>
                ...
                <Header  lengthItems={this.props.addedItems.length} />
                <ScrollView>
                    <View style={{backgroundColor:"#B0E0E6",flex:1}}>
                        <Heading text="Reproductive Health shop" />
                        <Bigdiv>
                            <View style={{flexDirection:"row"}}>
                                <Image resizeMode="contain" source={require("./images/mariecondoms.png")} 
                            ...
                            <Card 
                                ...
                                customIcon={
                                    <Image resizeMode="contain" 
                                        ...
                                        source={require("./images/ultrasound.png")} 
                                    />
                                } 

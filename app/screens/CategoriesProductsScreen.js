...
import {StyleSheet,View,Text,TextInput,TouchableOpacity,FlatList,Image,Button} from 'react-native'; 
          ...
          headerRight : () => (
            <View style={{flexDirection:"row"}}>
                ...
                <HeaderButtons HeaderButtonComponent={MyHeaderButton}>
                    <Item title="Favourite" iconName="search" 
                    onPress={()=>{
                        console.log("Pressed");
                    }}
                    />
    ...
    return (
        ...
        <View style={{overFlow:"hidden"}}>
           <Text numberOfLines={1} style={styles.text}>{book.item.title}</Text>
            ...
            <Text style={styles.text}>Price : UGX {book.item.Price}</Text>
            <Rating
...
export default CategoriesProductsScreen;//havent yet implemented the redux code.

...
import { Text, TouchableHighlight, View,TextInput,KeyboardAvoidingView,Platform} from "react-native";
        ...
        <KeyboardAvoidingView style={styles.centeredView} behavior="padding">
                <View style={styles.modalView}>
                    ...
                    <View style={{flexDirection:"row",marginTop:8}}>
                        ...
                        <Text style={{fontSize:15,fontWeight:"bold"}}>Service start date</Text>
                    </View>
                    <TouchableHighlight
                        style={{
                            ...styles.openButton,
